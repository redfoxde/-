    ...
    public List<Booking> getbooking(){
        ...
        try (
            ...
            while(resultSet.next()){
                ...
                booking.setGuest_name(resultSet.getString("guest_name"));
                booking.setRoom_number(resultSet.getInt("room_number"));
                booking.setCheck_in_date(resultSet.getDate("check_in_date").toLocalDate());
                booking.setCheck_out_date(resultSet.getDate("check_out_date").toLocalDate());
